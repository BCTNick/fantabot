...
class Auction:
    ...
    def single_player(self, player: Player, verbose: bool = False): 
        ...
        while True:
            ...
            if self.can_participate_in_bid(agent=current_agent, current_price=self.current_price, 
                                         position=player.role, slots=self.slots) is True:
            ...
            for role in roles:
                ...
                while True:
                    ...
                    if next_player is None:
                        break
                    self.single_player(next_player, verbose=verbose)
        else:
