    ...
    try:
        while True:
            ...
            for _ in range(episode_auctions):
                ...
                print(f" {auction_counter + 1} Auction starting")
        ...
        print(f"📊 Final plot saved as: training_progress_final_ep{n_episodes}.png")
        plt.savefig(f'training_progress_final_ep{n_episodes}.png', dpi=300, bbox_inches='tight')
